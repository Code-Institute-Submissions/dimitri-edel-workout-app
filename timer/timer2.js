...
class TimerOutput {
    ...
    initializeFields() {
        ...
        let ms_left = this.milliseconds_total - (this.min * min_factor)
...
class Timer {
    ...
    */
    displayProgress(callerInstance) {
        let ms_elapsed = Date.now() - callerInstance.start_time - callerInstance.pauseTotal;
...
let timer = new Timer("timer-text", "results-text", 100);
